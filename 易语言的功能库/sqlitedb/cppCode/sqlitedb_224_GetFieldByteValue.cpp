...
// 调用格式: SDT_BYTE (Sqlite记录集).读字段字节值, 命令说明: "读取当前记录中指定字段的值，并转换为字节型数据后返回。"
...
SQLITEDB_EXTERN_C void sqlitedb_GetFieldByteValue_224_sqlitedb(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
