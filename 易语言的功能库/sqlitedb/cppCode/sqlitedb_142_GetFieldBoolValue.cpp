...
// 调用格式: SDT_BOOL (Sqlite表).读字段逻辑值, 命令说明: "读取当前记录中指定字段的值，并转换为逻辑型数据后返回。"
...
SQLITEDB_EXTERN_C void sqlitedb_GetFieldBoolValue_142_sqlitedb(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
