...
// 调用格式: SDT_BIN (Sqlite记录集).读字段字节集值, 命令说明: "读取当前记录中指定字段的值，并转换为字节集型数据后返回。"
...
SQLITEDB_EXTERN_C void sqlitedb_GetFieldBinValue_219_sqlitedb(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
