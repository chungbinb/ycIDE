...
// 调用格式: SDT_TEXT (Sqlite表).读字段文本值, 命令说明: "读取当前记录中指定字段的值，并转换为文本型数据后返回。"
...
SQLITEDB_EXTERN_C void sqlitedb_GetFieldTextValue_137_sqlitedb(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
