#ifndef __INCLUDE_EWIZARD_HEADER_H__
#define __INCLUDE_EWIZARD_HEADER_H__
#include "elib/lib2.h"
#include "elib/lang.h"
#include "elib/krnllib.h"
#include "ewizard_cmd_typedef.h"

#define EWIZARD_EXTERN_C EXTERN_C
...
extern LIB_CONST_INFO g_ConstInfo_ewizard_global_var[];
extern int g_ConstInfo_ewizard_global_var_count;
extern CMD_INFO g_cmdInfo_ewizard_global_var[];
extern PFN_EXECUTE_CMD g_cmdInfo_ewizard_global_var_fun[];
extern int g_cmdInfo_ewizard_global_var_count;
extern ARG_INFO g_argumentInfo_ewizard_global_var[];
extern LIB_DATA_TYPE_INFO g_DataType_ewizard_global_var[];
extern int g_DataType_ewizard_global_var_count;
#endif

#define EWIZARD_DEF_CMD(_index, _szName, _szEgName, _szExplain, _shtCategory, _wState, _dtRetValType, _wReserved, _shtUserLevel, _shtBitmapIndex, _shtBitmapCount, _nArgCount, _pBeginArgInfo) \
    EXTERN_C void EWIZARD_NAME(_index, _szEgName)(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf);
EWIZARD_DEF(EWIZARD_DEF_CMD) // 所有实现命令的声明
