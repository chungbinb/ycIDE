...
// 调用格式: SDT_TEXT (XML树).[]取所有属性名, 命令说明: "取得由参数节点的所有属性名称组成的文本数组。"
...
EXMLPARSER_EXTERN_C void exmlparser_GetNodeAllAttrName_36_exmlparser(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
