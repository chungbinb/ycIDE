...
// 调用格式: SDT_TEXT (XML树).取节点名文本, 命令说明: "取得参数指定节点的节点名。通常用于以索引形式（如\"@1/@2\"）指定节点路径的情况。"
...
EXMLPARSER_EXTERN_C void exmlparser_GetNodeCaption_39_exmlparser(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
