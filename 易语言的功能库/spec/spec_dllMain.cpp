...
EXTERN_C INT WINAPI spec_ProcessNotifyLib_spec(INT nMsg, DWORD dwParam1, DWORD dwParam2);
...
static LIB_INFO g_LibInfo_spec_global_var = 
{
    ...
    /*m_szExplain*/             "本支持库提供部分相对特殊的命令，供易语言高级用户使用。", // 库详细解释
