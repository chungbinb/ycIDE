...
// 调用格式: SDT_BOOL (Java本地接口).置对象成员, 命令说明: "设置对象成员的值。成功返回“真”，失败返回“假”。"
...
JAVALIB_EXTERN_C void javalib_SetObjectField_23_javalib(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
