...
// 调用格式: SDT_BOOL (Java本地接口).取静态成员, 命令说明: "取对象静态成员的值，取出的是一个对象标志符，结果存到第三个参数“结果”中。成功返回“真”，失败返回“假”。"
...
JAVALIB_EXTERN_C void javalib_GetStaticField_25_javalib(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
