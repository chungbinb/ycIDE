...
// 调用格式: SDT_BOOL (Java本地接口).空方法, 命令说明: "调用对象的没有返回值的方法。调用成功返回“真”，失败返回“假”。"
...
JAVALIB_EXTERN_C void javalib_CallVoidMethod_32_javalib(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
