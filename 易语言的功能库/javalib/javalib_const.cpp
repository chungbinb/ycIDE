...
LIB_CONST_INFO g_ConstInfo_javalib_global_var[] = 
{
//#define    CT_NULL 0
...
//DOUBLE m_dbValue;         // CT_NUM、CT_BOOL
    /*000*/ { "本库开发代号", "LibAlias", NULL, 1, CT_TEXT, "JavaLib", 0 },
};
int g_ConstInfo_javalib_global_var_count = sizeof(g_ConstInfo_javalib_global_var) / sizeof(g_ConstInfo_javalib_global_var[0]);
#endif
