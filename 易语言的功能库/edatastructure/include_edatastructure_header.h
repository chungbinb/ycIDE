#ifndef __INCLUDE_EDATASTRUCTURE_HEADER_H__
#define __INCLUDE_EDATASTRUCTURE_HEADER_H__
#include "elib/lib2.h"
#include "elib/lang.h"
#include "elib/krnllib.h"
#include "edatastructure_cmd_typedef.h"

#define EDATASTRUCTURE_EXTERN_C EXTERN_C
...
extern LIB_CONST_INFO g_ConstInfo_edatastructure_global_var[];
extern int g_ConstInfo_edatastructure_global_var_count;
extern CMD_INFO g_cmdInfo_edatastructure_global_var[];
extern PFN_EXECUTE_CMD g_cmdInfo_edatastructure_global_var_fun[];
extern int g_cmdInfo_edatastructure_global_var_count;
extern ARG_INFO g_argumentInfo_edatastructure_global_var[];
extern LIB_DATA_TYPE_INFO g_DataType_edatastructure_global_var[];
extern int g_DataType_edatastructure_global_var_count;
#endif

#define EDATASTRUCTURE_DEF_CMD(_index, _szName, _szEgName, _szExplain, _shtCategory, _wState, _dtRetValType, _wReserved, _shtUserLevel, _shtBitmapIndex, _shtBitmapCount, _nArgCount, _pBeginArgInfo) \
    EXTERN_C void EDATASTRUCTURE_NAME(_index, _szEgName)(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf);
EDATASTRUCTURE_DEF(EDATASTRUCTURE_DEF_CMD) // 所有实现命令的声明
