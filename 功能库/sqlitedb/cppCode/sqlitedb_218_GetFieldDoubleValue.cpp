...
// 调用格式: SDT_DOUBLE (Sqlite记录集).读字段双精度小数值, 命令说明: "读取当前记录中指定字段的值，并转换为双精度小数型数据后返回。"
...
SQLITEDB_EXTERN_C void sqlitedb_GetFieldDoubleValue_218_sqlitedb(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
