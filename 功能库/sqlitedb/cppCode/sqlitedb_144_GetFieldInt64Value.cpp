...
// 调用格式: SDT_INT64 (Sqlite表).读字段长整数值, 命令说明: "读取当前记录中指定字段的值，并转换为长整数型数据后返回。"
...
SQLITEDB_EXTERN_C void sqlitedb_GetFieldInt64Value_144_sqlitedb(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
