...
// 调用格式: SDT_FLOAT (Sqlite表).读字段小数值, 命令说明: "读取当前记录中指定字段的值，并转换为小数型数据后返回。"
...
SQLITEDB_EXTERN_C void sqlitedb_GetFieldFloatValue_139_sqlitedb(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
