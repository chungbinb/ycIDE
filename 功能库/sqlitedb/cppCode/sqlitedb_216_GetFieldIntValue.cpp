...
// 调用格式: SDT_INT (Sqlite记录集).读字段整数值, 命令说明: "读取当前记录中指定字段的值，并转换为整数型数据后返回。"
...
SQLITEDB_EXTERN_C void sqlitedb_GetFieldIntValue_216_sqlitedb(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
