...
// 调用格式: SDT_DATE_TIME (Sqlite表).读字段日期时间值, 命令说明: "读取当前记录中指定字段的值，并转换为日期时间型数据后返回。"
...
SQLITEDB_EXTERN_C void sqlitedb_GetFieldDatetimeValue_143_sqlitedb(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
