...
static ARG_INFO g_argumentInfo_sqlitedb_global_var[] = 
{
...
const int dbg_cmd_arg_count__ = sizeof(g_argumentInfo_sqlitedb_global_var) / sizeof(g_argumentInfo_sqlitedb_global_var[0]);
#endif


#define SQLITEDB_DEF_CMDINFO(_index, _szName, _szEgName, _szExplain, _shtCategory, _wState, _dtRetValType, _wReserved, _shtUserLevel, _shtBitmapIndex, _shtBitmapCount, _nArgCount, _pBeginArgInfo) \
...
CMD_INFO g_cmdInfo_sqlitedb_global_var[] = 
{
    SQLITEDB_DEF(SQLITEDB_DEF_CMDINFO)
};

int g_cmdInfo_sqlitedb_global_var_count = sizeof(g_cmdInfo_sqlitedb_global_var) / sizeof(g_cmdInfo_sqlitedb_global_var[0]);
