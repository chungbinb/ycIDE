...
// 调用格式: SDT_INT (XML树).取子节点个数, 命令说明: "取得参数节点的所有子节点的个数。"
...
EXMLPARSER_EXTERN_C void exmlparser_GetChildNodeNumber_31_exmlparser(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
