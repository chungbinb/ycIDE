...
// 调用格式: SDT_TEXT (XML树).取属性值文本, 命令说明: "取得参数节点的特定属性值文本。"
...
// 参数<3>: [&执行结果 SDT_BOOL], 参数说明: "如果提供本参数，其中将存放本方法的执行结果——成功为“真”，失败为“假”。"
EXMLPARSER_EXTERN_C void exmlparser_GetNodeAttrValue_37_exmlparser(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
