...
// 调用格式: SDT_BIN (XML树).取节点值字节集, 命令说明: "取得参数节点的二进制数据值。"
...
EXMLPARSER_EXTERN_C void exmlparser_GetBinaryValue_34_exmlparser(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
