...
// 调用格式: SDT_INT (XML树).取属性个数, 命令说明: "取得由参数节点的属性个数。"
...
EXMLPARSER_EXTERN_C void exmlparser_GetNodeAttrCount_35_exmlparser(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
