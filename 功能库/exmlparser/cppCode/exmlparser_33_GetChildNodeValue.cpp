...
// 调用格式: SDT_TEXT (XML树).取节点值文本, 命令说明: "取得参数节点值文本。"
...
EXMLPARSER_EXTERN_C void exmlparser_GetChildNodeValue_33_exmlparser(PMDATA_INF pRetData, INT nArgCount, PMDATA_INF pArgInf)
{
